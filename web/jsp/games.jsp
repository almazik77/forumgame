    ...
    <div class="jumbotron text-center hoverable p-4"
        ...
        <div class="row" style="margin: 2% 1%">
            ...
            <div class=" text-md-left ml-3 mt-3">
                ...
                <h4 class="h4 mb-4"><%=game.getName()%>
                </h4>

                <p class="font-weight-normal"><%=game.getDescription()%>
                </p>
                <p class="font-weight-normal">by <a
                        href="<%=request.getContextPath() + "profile?id=" + game.getModeratorId()%>"><strong><%=game.getModeratorId()%>
                </strong></a>,
                </p>
            </div>
        </div>
